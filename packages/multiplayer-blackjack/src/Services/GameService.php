...
class GameService extends MultiplayerGameService
{
    ...
    protected function createGameable(): MultiplayerGameService
    {
...
//        $gameable->deck = array_merge(['DT','ST','HT','CT'], array_slice($gameable->deck, 4));
    ...
    public function action(string $action): MultiplayerGameService
    {
    ...
    protected function hit(Model $gameable): Model
    {
        ...
        $hand['cards'] = array_merge($hand['cards'], [$this->deck->getCard($drawnCardsCount + 1)]);
    ...
    protected function getGameEvent(string $action): array
    {
        ...
        $event = [
            ...
            'game' => $this->getGame()->only('is_completed', 'is_cancelled'),
            'gameable' => [
                'hands' => $gameable->hands
                    ->map(function ($hand) {
                        return [
