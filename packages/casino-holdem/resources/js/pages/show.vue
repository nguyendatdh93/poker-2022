<template>
  ...
  >
    ...
    <template v-slot:gameable.community_cards="{ item: { gameable } }">
      <card v-for="card in gameable.community_cards" :key="card" :card="card" />
    </template>
    ...
    <template v-slot:gameable.bonus_hand="{ item: { gameable } }">
      <template v-if="gameable.bonus_bet">
        <card v-for="card in gameable.player_bonus_hand" :key="card" :card="card" />
        /
        <span>{{ gameable.player_bonus_hand_title }}</span>
      </template>
      <span v-else>&mdash;</span>
    </template>
    ...
    <template v-slot:gameable.bonus_bet_win="{ item: { gameable } }">
      {{ gameable.bonus_bet }} / {{ gameable.bonus_win }}
    </template>
  </key-value-table>
</template>
