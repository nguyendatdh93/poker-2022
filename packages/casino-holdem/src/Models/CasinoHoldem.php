...
class CasinoHoldem extends Model implements ProvableGame
{
    ...
    protected $casts = [
        'deck'                  => 'collection',
        'player_cards'          => 'collection',
        'dealer_cards'          => 'collection',
        'community_cards'       => 'collection',
        'player_hand'           => 'collection',
        'player_bonus_hand'     => 'collection',
        'player_kickers'        => 'collection',
        'dealer_hand'           => 'collection',
        'dealer_kickers'        => 'collection',
    ...
    {
        return is_int($this->player_hand_rank) ? PokerHand::getTitle($this->player_hand_rank) : NULL;
    }
    ...
    public function getDealerHandTitleAttribute(): ?string
    {
        return !$this->dealer_qualified
            ? __('Not qualified')
            : (is_int($this->dealer_hand_rank) ? PokerHand::getTitle($this->dealer_hand_rank) : NULL);
    }

    public function getPlayerBonusHandTitleAttribute(): ?string
    {
        return is_int($this->player_bonus_hand_rank) ? PokerHand::getTitle($this->player_bonus_hand_rank) : NULL;
    }
