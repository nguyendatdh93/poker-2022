...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('install.process', ['step' => $step])); ?>">
        ...
        <div class="form-group">
            ...
            <input type="password" name="password" placeholder="password" class="form-control" value="<?php echo e(old('password', config('database.connections.mysql.password'))); ?>">
        </div>
        <div class="mt-3">
...
<?php echo $__env->make('installer::layouts.install', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zerocrypto\packages/installer/resources/views/pages/step2.blade.php ENDPATH**/ ?>