<template>
  <div class="suit">
    <svg style="display: none;">
      <symbol id="suit-C" viewBox="0 0 45.33 50.5" :fill="fillColor">
      ...
      <symbol id="suit-D" viewBox="0 0 45.33 50.5" :fill="fillColor">
      ...
      <symbol id="suit-H" viewBox="0 0 45.33 50.5" :fill="fillColor">
      ...
      <symbol id="suit-S" viewBox="0 0 45.33 50.5" :fill="fillColor">
    ...
    <svg v-if="suit" :fill="fillColor" :class="suitColor">
